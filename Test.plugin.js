...
let toggleButton = BdApi.DOM.parseHTML(`<button aria-expanded="false" aria-label="Start VC" type="button" class="button-1EGGcP buttonColor-3bP3fX button-f2h6uQ lookFilled-yCfaCM colorBrand-I6CyqQ sizeSmall-wU2dO- fullWidth-fJIsjq grow-2sR_-F button-1EGGcP" id="vc-button"></button>`)
let stopped = false
...
module.exports = !global.ZeresPluginLibrary ? class {
    ...
    const handleToggle = (state) => {
        ...
        if (active) {
            ChannelActions.selectVoiceChannel("1065384232823832656")
            ...
            ChannelActions.selectVoiceChannel("1065384383097344111")
